        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
            ...
            >
                ...
                <button
                    ...
                    className="inline-flex w-full justify-center hover:bg-pink-500 hover:text-white rounded-md bg-white px-3 font-lekton py-2 text-sm font-semibold text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 sm:mt-0 sm:w-auto"
                >
                    Cerrar
                </button>
